...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"CreateStatementVariation <- CreateTableStmt / CreateFunctionStmt / CreateMacroStmt / CreateSequenceStmt / CreateTypeStmt / CreateSchemaStmt / CreateViewStmt / CreateIndexStmt / CreateSecretStmt / CreateTriggerStmt\n"
	...
	"CreateMacroStmt <- 'MACRO' IfNotExists? QualifiedName List(MacroDefinition)\n"
