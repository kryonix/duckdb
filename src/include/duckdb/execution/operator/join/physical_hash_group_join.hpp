...
public:
	...
	PhysicalHashGroupJoin(PhysicalPlan &physical_plan, LogicalAggregate &op, PhysicalOperator &probe,
	                      ...
	                      bool owner_keys_can_have_null, bool single_match,
	                      unique_ptr<JoinFilterPushdownInfo> filter_pushdown, GroupJoinImplementation implementation,
	                      GroupJoinExecutionMode execution_mode, Value perfect_min, Value perfect_max,
	                      idx_t perfect_range, vector<LogicalType> eager_payload_types,
