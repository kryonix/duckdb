...
private:
	...
	//! Aggregate a factorized join at driver grain, then combine its states into coarser result groups.
	bool TryFactorizedCoarseGrouping(unique_ptr<LogicalOperator> &op);
