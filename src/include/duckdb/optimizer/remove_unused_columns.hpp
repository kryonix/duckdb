...
private:
	...
	void RemapProjectionMap(LogicalOperator &op, idx_t child_index, const vector<ColumnBinding> &old_child_bindings);
	void ResolveProjectionBindings(ColumnBinding binding, const column_binding_set_t &new_bindings,
